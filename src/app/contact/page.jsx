...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="relative flex md:items-center md:justify-center mb-6 md:h-screen bg-center bg-cover">
        <Image src={contact} alt="contact" layout="fill" objectFit="cover" />

        <div className="absolute inset-0 bg-black/70 z-[2]" />
        <div className="p-5 text-white z-[3] absolute flex flex-col items-center justify-center w-full h-full">
