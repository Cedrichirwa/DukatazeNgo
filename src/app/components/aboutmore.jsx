    ...
    <>
      <div>
        ...
        <div className="flex flex-col justify-center items-center w-full h-fit">
          ...
          <div className="-mt-6 flex lg:items-center text-white lg:justify-center bg-slate-100 border border-yellow-500 pt-4">
            <div className="p-5 text-black">
              ...
              <h2 className="font-bold flex py-1 justify-center items-center gap-2 text-xl text-cyan-700">
                <span>
                  <svg
              ...
              <p className="sm:p-4 lg:mx-10 md:mx-0 p-0 max-md:text-sm sm:text-center">
                We envision a world where teenage pregnancy and menstrual stigma
                no longer exist.
              </p>
